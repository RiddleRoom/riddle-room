...
void loop() {
  if (keyboard.available()) {
    ...
    else if (c == '2' || stampCount = 2) {
      timestamp2();
      }
      
    else if (c == '3' || stampCount = 3) {
      timestamp3();
      }
      
    else if (c == '4' || stampCount = 4) {
      timestamp4();
      }
      
    else if (c == '5' || stampCount = 5) {
      timestamp5();
      }

    else if (c == '6' || stampCount = 6) {
      timestamp6();
      }   
      
    else if (c == '7' || stampCount = 7) {
      timestamp7();
      }   
      
    else if (c == '8' || stampCount = 8) {
      timestamp8();
      }   

    else if (c == '9' || stampCount = 9) {
      timestamp9();
      }   
  }
  else {
